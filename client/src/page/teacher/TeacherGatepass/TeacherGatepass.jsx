...
const TeacherGatepass = () => {
    ...
    useEffect(() => {
      const fetchGatepasses = async () => {
        try {
          const pendingResponse = await fetch("http://${apiBaseUrl}/api/gatepasses/pending");
          const approvedResponse = await fetch("http://${apiBaseUrl}/api/gatepasses/approved");
          const rejectedResponse = await fetch("http://${apiBaseUrl}/api/gatepasses/rejected");
    ...
    const updateGatepassStatus = async (id, status) => {
      try {
        const response = await fetch("http://${apiBaseUrl}/api/gatepasses/update-status", {
          method: "PUT",
          headers: {
